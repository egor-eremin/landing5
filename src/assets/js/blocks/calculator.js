...
(function(window) {
    ...
    var getCalculate = {
        ...
        defaultTitles: {
            ...
            "pl": {
                "globalTitle": "Kalkulator tradera",
                "group_instrument": "Grupa instrumentów",
                "type_account": "Typ portfela",
                "account_currency": "Waluta portfela",
                "leverage": "Wpływ",
                "instrument": "Instrument",
                "order_transaction_volume": "Tom",
                "type_order": "Rodzaj",
                "sell": "Sell",
                "buy": "Buy",
                "price_open": "Cena otwarcia",
                "price_close": "Cena zamykająca",
                "standart": "Standardowy (USD, EUR)",
                "gold": "Złoto (XAU)",
                "bitcoin": "Krypto (BTC)",
                "submitBtn": "Oblicz",
                "resetBtn": "Jasne",
                ...
                "margin": "Margin",
                "profit": "Zysk ",
                "accParametrs": "Ustawienia konta",
                "posParametrs": "Parametry pozycji",
                "resultText": "Porównaj możliwe wyniki strategii handlowej z danymi źródłowymi"
            },
            "tr": {
                globalTitle: "Tüccarın hesap makinesi",
                group_instrument: "Araç grubu",
                type_account: "Hesap tipi",
                account_currency: "Hesap para birimi",
                leverage: "Kaldıraç",
                instrument: "Araç",
                order_transaction_volume: "İşlem hacmi",
                type_order: "Sipariş türü",
                price_open: "Açılış fiyatı",
                price_close: "Kapanış fiyatı",
                standart: "Standart",
                gold: "Altın",
                bitcoin: "Bitcoin",
                submitBtn: "Hesaplamak",
                resetBtn: "Temizlemek",
                in: " ",
                swop: "Swap",
                "spread": "Spread",
                ...
                margin: "Marj",
                profit: "Kâr ",
                accParametrs: "Hesap ayarları",
                posParametrs: "Pozisyon parametreleri",
                resultText: "Ticaret stratejisinin olası sonuçlarını kaynak verilerle karşılaştırın"
            }
        },
        currency: {
            standart: ['USD', 'EUR'],
        ...
        getBuild: function(lang, idBlock) {
            ...
            if (mainBlock) {
                ...
                if (this.defaultTitles[lang]) {
                    ...
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-ver-2 btn-second" onclick="getCalculate.cleanAll(\'' + langBuild + '\');"><span>' + this.defaultTitles[langBuild].resetBtn + '</span></button>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
