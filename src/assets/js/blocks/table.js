...
function gobuild (obj, data, item, langs) {
    ...
    prevobjcot.forEach( (element) => {
        ...
        htmlContent += '<td><div class="table-btn-wrapper"><a class="btn-sell btn_white btn btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '"><span>' + langs.sell + '</span></a><a class="btn-buy btn btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '"><span>' + langs.buy + '</span></a></div></td>';
        htmlContent += '</tr>';
    })
