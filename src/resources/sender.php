...
const EMAIL   = 'info@companyname.co';
const FROM    = 'Company Name <info@companyname.co>';
...
if (isset($_GET["class"]) || isset($_GET["id"]))
{
	...
	if ($formId) {
        ...
        if (pageUrl[i] == 'ru' || pageUrl[i] == 'es' || pageUrl[i] == 'de' || pageUrl[i] == 'fr' || pageUrl[i] == 'it' || pageUrl[i] == 'zh' || pageUrl[i] == 'pl' || pageUrl[i] == 'tr') {
